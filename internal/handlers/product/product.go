...
import (
	"dynamodb-crud/controllers/product"
	"dynamodb-crud/internal/handlers"
	"dynamodb-crud/internal/handlers/product"

	EntityProduct "dynamodb-crud/internal/entities/product"
	"dynamodb-crud/internal/repository/adapter"
	Rules "dynamodb-crud/internal/rules"
	RulesProduct "dynamodb-crud/internal/rules/product"
...
func (h *Handler) getBodyAndValidate(r *http.Request, ID uuid.UUID) (*EntityProduct.Product, error) {
	...
	setDefultValues(productParsed, ID)
	return productParsed, h.Rule.Validate(productParsed)
}

func setDefultValues(product *EntityProduct.Product, ID uuid.UUID) {
